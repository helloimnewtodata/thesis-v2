#
# ============================================================
# REGIME STRATEGY BENCHMARK v3 (soft3): HMM, HMM2, HMM3 mukana
# ============================================================
#
# Identtinen versio regime_strategy_benchmark_soft2.py:n kanssa, paitsi:
#   - lisaa HMM3 vertailuun (sticky transmat, realized vol -feature,
#     EWMA-posterior smoothing; muut HMM2-parannukset pidetty)
#   - kaikki output-tiedostonimet "soft3"-suffiksilla
#
# Kaytto: aja ensin src/HMM.py, src/HMM2.py, src/HMM3.py, src/GMM.py ja src/JM.py.
#
import os
import warnings
...
RETURNS_OUTPUT = OUTPUT_DIR / "regime_strategy_returns_soft3.csv"
METRICS_OUTPUT = OUTPUT_DIR / "regime_strategy_metrics_soft3.csv"
REGIME_ACCURACY_OUTPUT = OUTPUT_DIR / "regime_strategy_regime_accuracy_soft3.csv"
CUMULATIVE_PLOT = OUTPUT_DIR / "cumulative_returns_hmm_gmm_jm_soft3.png"
DRAWDOWN_PLOT = OUTPUT_DIR / "drawdowns_hmm_gmm_jm_soft3.png"
WEIGHT_PLOT = OUTPUT_DIR / "regime_weights_hmm_gmm_jm_soft3.png"
...
def plot_cumulative_returns(strategies: pd.DataFrame, model_names: list, output_path: Path):
    ...
    ax.set_xlabel("Date")
    ax.set_title(
        f"Soft-weight regime strategies (incl. HMM2/HMM3) vs. BH "
...
def print_comparison(
    ...
    print(f"\n=== Metrics (TC={TRANSACTION_COST*1e4:.1f} bps, soft weights, soft3 run) ===")
...
def main():
    ...
    print(
        f"Soft3 regime benchmark (incl. HMM2, HMM3): {START_DATE} → {END_DATE}, "
    ...
    if not model_dfs:
        raise RuntimeError(
            "No regime files found. Run HMM.py, HMM2.py, HMM3.py, GMM.py and JM.py first."
        )
